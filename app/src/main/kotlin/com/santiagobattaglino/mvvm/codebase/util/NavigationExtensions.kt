...
private fun BottomNavigationView.setupItemReselected(
    ...
    setOnNavigationItemReselectedListener { item ->
        Log.d("NavExtensions", "item $item")

        val newlySelectedItemTag = graphIdToTagMap[item.itemId]
        Log.d("NavExtensions", "newlySelectedItemTag $newlySelectedItemTag")
...
// item = "Create Incident newlySelectedItemTag = bottomNavigation#2
