package com.santiagobattaglino.mvvm.codebase.presentation.ui.access
...
class Validator {
    ...
    companion object {
        ...
        private val PASSWORD_POLICY = "Enter a valid password"
         ...
         */
        fun isValidName(data: Any, updateUI: Boolean = true, msg: String? = null): Boolean {
            val str =
                getText(data)
            ...
            if (updateUI) {
                val error: String? = if (valid) null else msg ?: NAME_VALIDATION_MSG
                setError(
                    data,
                    error
                )
        ...
        fun isValidPassword(data: Any, updateUI: Boolean = true): Boolean {
            ...
            // Password should be minimum minimum 4 characters long
            if (str.length < 4) {
                valid = false
            }
